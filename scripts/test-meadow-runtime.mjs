...
class El {
  ...
  getContext(){return {fillText(){},beginPath(){},ellipse(){},fill(){},createImageData(w,h){return {data:new Uint8ClampedArray(w*h*4)};},putImageData(){}};}
}
...
const worldSource=fs.readFileSync(new URL('../js/meadow-world.js',import.meta.url),'utf8').replace("'three'",JSON.stringify(threeURL)).replace("'./explore-state.js?v=20260907meadow'",JSON.stringify(new URL('../js/explore-state.js',import.meta.url).href));
